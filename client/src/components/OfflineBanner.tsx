...
export const OfflineBanner: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-amber-600 to-rose-600 text-white py-2 px-4 text-center text-xs font-semibold tracking-wide flex items-center justify-center space-x-2.5 shadow-md border-b border-rose-500/20 select-none animate-slide-down">
